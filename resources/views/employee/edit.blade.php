...
<head>
<meta charset="UTF-8">
<title>Edit Employee Form - Laravel 8 CRUD Tutorial</title>
...
<input type="text" name="phone_no" value="{{ $employee->phone_no }}" class="form-control" placeholder="Employee Phone">
@error('phone_no')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
